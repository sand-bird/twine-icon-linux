...
# Legal Stuff:
#
# This file is part of the Moka Icon Theme and is free software; you can redistribute
# it and/or modify it under the terms of the GNU Lesser General Public License as 
# published by the Free Software Foundation; version 3.
#
# This file is part of the Moka Icon Theme and is distributed in the hope that it 
...
# (may be 90 or 96 depending on your inkscape build)
DPI_1_TO_1 = 90
...
def main(args, SRC):
    ...
    class ContentHandler(xml.sax.ContentHandler):
        ...
        def startElement(self, name, attrs):
            filename = os.path.basename(self.path).split('.')[0].split("_")
            if len(filename) == 2:
                self.context = filename[0]
                self.icon_name = filename[1]
            else:
                self.context = ""
                self.icon_name = filename[0]
